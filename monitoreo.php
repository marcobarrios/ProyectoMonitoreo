    ...
    <form name="myform" method="post" action="controllers/guardardatos.php" id = "myform">
        ...
        <div id="groupA" name="groupA">
            ...
            <div id="div_id_dedica" class="form-group">
                <label class = "pregunta" onclick="PlaySound('a4')" onmouseout="StopSound('a4')">4. ¿A qué se dedica actualmente?</label>
                <div class="controls">
        ...
        <div id="groupB" name="groupB">
            ...
            <div id="div_id_veces_visita" class="form-group">
                ...
                <div class="controls ">
                    ...
                    <label onclick="PlaySound('b2-2')" onmouseout="StopSound('b2-2')"><input type="radio" name="veces_visita" value="2" /> Con Regularidad <br></label>
        ...
        <div id="groupC" name="groupC">
            ...
            <div id="div_id_relacion_6meses" class="form-group">
                <label class = "pregunta" onclick="PlaySound('c2')" onmouseout="StopSound('c2')">2. ¿Has tenido relaciones sexuales en los últimos 6 meses?
                </label>
                <div class="controls ">
                    <input type="radio" name="relacion_6meses" value="0" hidden="" checked="true"/>
                    <label onclick="PlaySound('c2-1')" onmouseout="StopSound('c2-1')"><input type="radio" name="relacion_6meses" value="1" /> Si <br></label>
                    <label onclick="PlaySound('c2-2')" onmouseout="StopSound('c2-2')"><input type="radio" name="relacion_6meses" value="2" /> No <br></label>
                </div>
            </div>
            ...
            <div id="div_id_estado_relacion" class="form-group">
                ...
                <div class="controls ">
                    ...
                    <label onclick="PlaySound('c3-3')" onmouseout="StopSound('c3-3')"><input type="radio" name="estado_relacion" value="3" /> Violación <br></label>
                </div>
            </div>
        ...
        <div id="groupE" name="groupE">
            ...
            <div id="div_id_existe_kit" class="form-group">
                <label class = "pregunta" onclick="PlaySound('e2')" onmouseout="StopSound('e2')">2. ¿El centro de servicio cuenta con Kit de emergencia?</label>
                <div class="controls ">
