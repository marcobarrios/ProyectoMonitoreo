    ...
    <div id="groupA" name="groupA">
        ...
        <div id="div_id_sexo" class="form-group">
            ...
            <div class="controls">
                ...
                <label onclick="PlaySound('a1-2')" onmouseout="StopSound('a1-2')"><input type="radio" name="genero" value="2" /> Masculino <br> <br></label>
        ...
        <div id="div_id_rango_edad" class="form-group">
            ...
            <div class="controls">
                ...
                <label onclick="PlaySound('a2-5')" onmouseout="StopSound('a2-5')"><input type="radio" name="rangoedad" value="5"/> Más de 25 años <br> <br></label>
        ...
        <div id="div_id_estado_civil" class="form-group">
            ...
            <div class="controls">
                ...
                <label onclick="PlaySound('a3-4')" onmouseout="StopSound('a3-4')"><input type="radio" name="estadocivil" value="4"/> Divorciado <br> <br></label>
        ...
        <div id="div_id_dedica" class="form-group">
            ...
            <div class="controls" onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('a4-4')" onmouseout="StopSound('a4-4')"><input type="radio" name="dedica" value="4"/> Ninguno <br> <br></label>
        ...
        <div id="div_id_trabajo" class="form-group">
            ...
            <div class="controls" onchange="SelectChanged();">
                ...
                <label><input type="radio" name="otrotrabajo" value="9"/> Otro <br> <br></label>
        ...
        <div id="div_id_otrotrabajo" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_otro_trabajo" maxlength="45" name="otro_trabajo" type="text" placeholder="Ingresa otro trabajo">
            </div>
        </div>
        ...
        <div id="div_id_cultura" class="form-group">
            ...
            <div class="controls" onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('a5-8')" onmouseout="StopSound('a5-8')"><input type="radio" name="cultura" value="8" /> Otro <br> <br></label>
        ...
        <div id="div_id_otra_cultura" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_otra_cultura" maxlength="45" name="otra_cultura" type="text" placeholder="Ingresa cultura">
            </div>
        </div>
    </div>
    ...
    <div id="groupB" name="groupB">
        ...
        <div id="div_id_idservicio_salud" class="form-group">
            ...
            <div class="controls" onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('b1-6')" onmouseout="StopSound('b1-6')"><input type="radio" name="idservicio_salud" value="6" /> Otros <br> <br></label>
        ...
        <div id="div_id_otro_servicio" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_otro_servicio" maxlength="45" name="otro_servicio_salud" type="text" placeholder="Especifica servicio o establecimiento">
            </div>
        </div>
        ...
        <div id="div_id_veces_visita" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('b2-3')" onmouseout="StopSound('b2-3')"><input type="radio" name="veces_visita" value="3" /> De vez en cuando <br> <br></label>
        ...
        <div id="div_id_motivo_acercamiento" class="form-group">
            ...
            <div class="controls" onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('b3-7')" onmouseout="StopSound('b3-7')"><input type="radio" name="motivo_acercamiento" value="7" /> Otros <br> <br></label>
        ...
        <div id="div_id_especifica_motivo" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_especifica_motivo" maxlength="45" name="especifica_motivo" type="text" placeholder="Especifica motivo">
            </div>
        </div>
        ...
        <div id="div_id_personal_capacitado_im" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('b4-2')" onmouseout="StopSound('b4-2')"><input type="radio" name="personal_capacitado" value="2" /> No <br> <br></label>
        ...
        <div id="div_id_donde_escucho" class="form-group">
            ...
            <div class="controls " onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('b5-5')" onmouseout="StopSound('b5-5')"><input type="radio" name="donde_escucho" value="5" /> Otros <br> <br></label>
        ...
        <div id="div_id_especifica_escucho" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_especifica_escucho" maxlength="45" name="especifica_escucho" type="text" placeholder="Especifica lugar">
            </div>
        </div>
        <div id="div_id_consige_condones" class="form-group">
            ...
            <div class="controls " onchange="SelectChanged();">
                ...
                <label><input type="radio" name="consigue_condones" value="7" /> En ningún lugar <br> <br></label>
        ...
        <div id="div_id_otro_lugar_condones" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_otro_lugar_condones" maxlength="45" name="otro_lugar_condones" type="text" placeholder="Especifica lugar">
            </div>
        </div>
        ...
        <div id="div_id_consigue_metodos" class="form-group">
            ...
            <div class="controls " onchange="SelectChanged();">
                ...
                <label><input type="radio" name="consigue_metodos" value="7" /> En Ningun Lugar <br> <br></label>
        ...
        <div id="div_id_otro_lugar_metodos" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_otro_lugar_metodos" maxlength="45" name="id_otro_lugar_metodos" type="text" placeholder="Especifica lugar">
            </div>
        </div>
    </div>
    ...
    <div id="groupC" name="groupC"  >
        ...
        <div id="div_id_id_inicio_relacion" class="form-group">
            ...
            <div class="controls " onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('c1-1')" onmouseout="StopSound('c1-1')"><input type="radio" name="inicio_relacion" value="1" /> De 10 a 15 años <br></label>
                ...
                <label onclick="PlaySound('c1-4')" onmouseout="StopSound('c1-4')"><input type="radio" name="inicio_relacion" value="4" /> No he tenido relaciones sexuales <br> <br></label>
        ...
        <div id="div_id_frecuenciarelacion" class="form-group">
            ...
            <div class="controls ">
                ...
                <label><input type="radio" name="frecuenciarelaciones" value="3" /> Solo una vez <br> <br></label>
        ...
        <div id="div_id_estado_relacion" class="form-group">
            ...
            <div class="controls ">
                ...
                <label><input type="radio" name="estado_relacion" value="4" /> Fue de forma consensuada <br> <br></label>
        ...
        <div id="div_id_quien_relacion" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('c4-4')" onmouseout="StopSound('c4-4')"><input type="radio" name="quien_relacion" value="4" /> Persona desconocida <br> <br></label>
        ...
        <div id="div_id_utilizo_condon" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('c5-2')" onmouseout="StopSound('c5-2')"><input type="radio" name="utilizo_condon" value="2" /> No <br> <br></label>
        ...
        <div id="div_id_sabe_condon" class="form-group">
            ...
            <div class="controls " onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('c6-2')" onmouseout="StopSound('c6-2')"><input type="radio" name="sabe_condon" value="2" /> No <br> <br></label>
        ...
        <div id="div_pasoscondon" class="form-group">
            <label for="id_pasoscondon" class="control-label ">Menciona los pasos del uso correcto del condón. </label>
            <div class="controls ">
              <textarea rows="4" cols="40" placeholder="Ingresa los pasos aquí:" maxlength="255" id="pasoscondon" name="pasoscondon"></textarea>
            </div>
        </div>
        ...
        <div id="div_id_servicio_sugerido" class="form-group">
            ...
            <div class="controls " onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('c8-6')" onmouseout="StopSound('c8-6')"><input type="radio" name="servicio_sugerido" value="6" /> Otros <br> <br></label>
        ...
        <div id="div_otro_servicio_sugerido" class="form-group">
            <label for="id_otro_servicio_sugerido" class="control-label ">Especifica otro servicio</label>
            <div class="controls ">
                <input class="textinput textInput form-control" id="otro_servicio_sugerido" maxlength="45" name="otro_servicio_sugerido" type="text" placeholder="Especifica otro servicio">
            </div>
        </div>
    </div>
    ...
    <div id="groupD" name="groupD">
        ...
        <div id="div_id_quien_debe_utilizar" class="form-group">
            ...
            <div class="controls">
                ...
                <label onclick="PlaySound('d1-4')" onmouseout="StopSound('d1-4')"><input type="radio" name="quien_debe_utilizar" value="4" /> Para los de la ciudad <br> <br></label>
        ...
        <div id="div_id_hablarcondonpareja" class="form-group">
            ...
            <div class="controls">
                ...
                <label><input type="radio" name="hablarcondonpareja" value="2" /> No <br> <br></label>
        ...
        <div id="div_id_mujer_derecho_relacion" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('d4-2')" onmouseout="StopSound('d4-2')"><input type="radio" name="mujer_derecho_relacion" value="2" /> No <br> <br></label>
        ...
        <div id="div_porque_derecho_relacion" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="porque_derecho_relacion" maxlength="45" name="porque_derecho_relacion" type="text" placeholder="Especifica por qué">
            </div>
        </div>
        ...
        <div id="div_id_mujer_derecho_condon" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('d5-2')" onmouseout="StopSound('d5-2')"><input type="radio" name="mujer_derecho_condon" value="2" /> No <br> <br></label>
        ...
        <div id="div_porque_derecho_condon" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="porque_derecho_condon" maxlength="45" name="porque_derecho_condon" type="text" placeholder="Especifica por qué">
            </div>
        </div>
        ...
        <div id="div_id_por_idioma" class="form-group">
            ...
            <div class="controls " onchange="SelectChanged();">
                ...
                <label onclick="PlaySound('d6-4')" onmouseout="StopSound('d6-4')"><input type="radio" name="por_idioma" value="4" /> Otro <br> <br></label>
        ...
        <div id="div_id_otra_razon" class="form-group">
            ...
            <div class="controls ">
                <input class="textinput textInput form-control" id="id_otra_razon" maxlength="45" name="id_otra_razon" type="text" placeholder="Especifica otra razon">
            </div>
        </div>
    </div>
    ...
    <div id="groupE" name="groupE">
        ...
        <div id="div_id_existe_servicio" class="form-group">
            ...
            <div class="controls">
                ...
                <label onclick="PlaySound('e1-2')" onmouseout="StopSound('e1-2')"><input type="radio" name="existe_servicio" value="2" /> No <br> <br></label>
        ...
        <div id="div_id_existe_kit" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('e2-2')" onmouseout="StopSound('e2-2')"><input type="radio" name="existe_kit" value="2" /> No <br> <br></label>
                <label><input type="radio" name="existe_kit" value="3"/>No se la respuesta <br></label>
                <label><input type="radio" name="existe_kit" value="4"/>No quiero contestar <br></label>
            </div>
        </div>
        ...
        <div id="div_id_prestador_conoce" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('e3-2')" onmouseout="StopSound('e3-2')"><input type="radio" name="prestador_conoce" value="2" /> No <br> <br></label>
    ...
    <div id="groupF" name="groupF">
        ...
        <div id="div_id_califica_servicio" class="form-group">
            ...
            <div class="controls">
                ...
                <label onclick="PlaySound('f1-4')" onmouseout="StopSound('f1-4')"><input type="radio" name="califica_servicio" value="4" /> Deficiente <br> <br></label>
        ...
        <div id="div_id_horario_atencion" class="form-group">
            ...
            <div class="controls ">
                ...
                <label onclick="PlaySound('f2-3')" onmouseout="StopSound('f2-3')"><input type="radio" name="horario_atencion" value="3" /> Inaccesible <br> <br></label>
